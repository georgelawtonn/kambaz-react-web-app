        ...
        <div id="wd-lab1">
            ...
            <div id="wd-p-tag">
                ...
                <p id="wd-p-3">
                    ...
                    above and this paragraph, by default browsers render them as one contiguous piece of text as shown
                    here on the right.
                </p>
                <p id="wd-p-4">
                    This is the third paragraph. Wrap each paragraph with the paragraph tag to tell browsers to render
                    the gaps.
                </p>
            </div>
            <div id="wd-list">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Freeze ripened bananas</li>
                    <li>Retrieve matcha powder</li>
                    <li>Put the frozen bananas and matcha powder into a blender</li>
                    <li>Blend alongside milk or yogurt, and honey</li>
                    <li>Put the mix into a cup and enjoy!</li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <input type="text" title="George" value="George" id="wd-text-fields-first-name"/> <br/>
                    <label htmlFor="wd-text-fields-last-name">Last name:</label>
                    <input type="text" placeholder="Lawton"
                           value="Lawton"
                           title="The last name"
                    ...
                    Please
                    <a href="https://github.com/georgelawtonn/kambaz-react-web-app" id="wd-github"> click here</a>
                    to get to the GitHub code repository<br/>
